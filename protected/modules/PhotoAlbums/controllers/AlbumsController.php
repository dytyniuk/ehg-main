...
class AlbumsController extends Controller
{
	...
	{
		if( Yii::app()->user->checkAccess('PhotoAlbum.albums.actionView', array('album_id' => $id)) ){
	...
	{
		if( Yii::app()->user->checkAccess('PhotoAlbum.albums.actionCreate') ){
			$model=new Albums;
	...
	{
		if( Yii::app()->user->checkAccess('PhotoAlbum.albums.actionUpdate', array('album_id' => $id)) ){
			$model=$this->loadModel($id);
	...
	{	
		if( Yii::app()->user->checkAccess('PhotoAlbum.albums.actionDelete', array('album_id' => $id)) ){
			$model = $this->loadModel($id);
	...
	{
		if( Yii::app()->user->checkAccess('PhotoAlbum.albums.actionIndex') ){
	...
	{
		if( Yii::app()->user->checkAccess('PhotoAlbum.albums.actionAdmin') ){
